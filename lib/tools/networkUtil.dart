...
import 'package:it_home/global.dart';
...
class NetworkUtil {
  ...
  static void get(String url, Function callBack, {Map<String, String> params, Function errorCallBack}) async {
    _request(Api.baseUrl + url, callBack, method: GET, params: params, errorCallBack: errorCallBack);
  }

  //post请求
  static void post(String url, Function callBack, {Map<String, String> params, Function errorCallBack}) async {
    _request(Api.baseUrl + url, callBack, method: POST, params: params, errorCallBack: errorCallBack);
  }
